...
extension PlaylistQueryFilter
  ...
  QueryBuilder<Playlist, Playlist, QAfterFilterCondition> itemsIsNull() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Playlist, Playlist, QAfterFilterCondition> itemsIsNotNull() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Playlist, Playlist, QAfterFilterCondition> titleIsNull() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(const FilterCondition.isNull(
        property: r'title',
      ));
  ...
  QueryBuilder<Playlist, Playlist, QAfterFilterCondition> titleIsNotNull() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(const FilterCondition.isNotNull(
        property: r'title',
      ));
